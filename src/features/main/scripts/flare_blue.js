...
class FlareBlue extends Flare {
    constructor() {
        ...
        sprite('main/prize_orb/flare.png').addTo(this).rotation(random.uniform(0, 2 * Math.PI)).blending('ADD').sprite;
        sprite('main/prize_orb/flare.png').addTo(this).rotation(random.uniform(0, 2 * Math.PI)).blending('ADD').sprite;
        this.circle = sprite('main/prize_orb/flare_circle.png').addTo(this).scale(1).blending('ADD').sprite;
    }
